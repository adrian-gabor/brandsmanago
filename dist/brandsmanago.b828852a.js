...
var _featuredProductsJs = require("./featuredProducts.js");
var _apiJs = require("./api.js");
var _productListingJs = require("./productListing.js");
var _hamburgerMenuJs = require("./hamburgerMenu.js");
const pageNumber = 1;
const pageSize = 10;
document.addEventListener('DOMContentLoaded', async ()=>{
    try {
        const products = await (0, _apiJs.fetchProducts)(pageNumber, pageSize);
        (0, _featuredProductsJs.displayFeaturedProducts)(products);
    } catch (error) {
        console.error("B\u0142\u0105d \u0142adowania produkt\xf3w do karuzeli w DOMContentLoaded:", error);
    }
    (0, _hamburgerMenuJs.setupHamburgerMenu)();
    (0, _productListingJs.setupProductListing)();
});

},{"./featuredProducts.js":"2ArIM","./api.js":"4yEOZ","./productListing.js":"bbQd9","./hamburgerMenu.js":"lLNkX"}],"2ArIM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayFeaturedProducts", ()=>displayFeaturedProducts);
var _favFillSvg = require("url:../assets/FAV-FILL.svg");
var _favFillSvgDefault = parcelHelpers.interopDefault(_favFillSvg);
/**
 * Wyświetla produkty w karuzeli "Featured Products".
 * @param {Array} products - Tablica produktów do wyświetlenia w karuzeli.
 */ console.log("\u015Acie\u017Cka do ikony po przetworzeniu przez Parcel:", (0, _favFillSvgDefault.default));
        ...
        productCard.innerHTML = `
            <div class="product-featured-image-container">
                ...
                <span class="product-favorite-btn" aria-label="Dodaj do ulubionych">
                    <img class="heart-icon" src="${0, _favFillSvgDefault.default}" alt="Serduszko"/> 
                </span>
            </div>
 ...
 */ function setupCarouselNavigation() {
    ...
    if (nextButton && productsList) nextButton.addEventListener('click', ()=>{
...
},{"url:../assets/FAV-FILL.svg":"inGeJ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"inGeJ":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("FAV-FILL.430ba14d.svg") + "?" + Date.now();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bbQd9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setupProductListing", ()=>setupProductListing);
var _apiJs = require("./api.js");
...
function setupProductListing() {
    ...
    if (productModal) document.addEventListener('keydown', (e)=>{
 ...
 */ async function fetchProductListing(pageSize) {
    ...
    try {
        const products = await (0, _apiJs.fetchProducts)(pageNumber, pageSize);
        if (products) displayProductListing(products);
    } catch (error) {
        console.error("Wyst\u0105pi\u0142 b\u0142\u0105d podczas pobierania produkt\xf3w do listy:", error);
    }
}
/**
 ...
 */ function displayProductListing(products) {
    ...
    products.forEach((product, index)=>{
        ...
        if (promoBanner) {
            if (window.matchMedia('(min-width: 1024px)').matches && index === 4) productsList.appendChild(promoBanner);
            else if (window.matchMedia('(max-width: 1023px)').matches && index === 3) productsList.appendChild(promoBanner);
        }
    });
}
/**
...
},{"./api.js":"4yEOZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lLNkX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Inicjalizuje obsługę menu hamburgerowego.
 */ parcelHelpers.export(exports, "setupHamburgerMenu", ()=>setupHamburgerMenu);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["93v64","lhpGb"], "lhpGb", "parcelRequire5f26", {}, "./", "/")

//# sourceMappingURL=brandsmanago.b828852a.js.map
